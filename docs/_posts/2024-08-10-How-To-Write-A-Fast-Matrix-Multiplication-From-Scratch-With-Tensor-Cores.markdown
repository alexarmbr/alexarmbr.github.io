...
This article contains a background section that explains some theory that is helpful to have in your head when thinking about how to optimize kernels that operate on matrices. The rest of the article explains six algorithmic techniques that I used to make my kernel run as fast as possible. Code can be found [here](https://github.com/alexarmbr/matmul-playground) on github, and [here](https://news.ycombinator.com/item?id=43736739) is a hacker news thread where you can leave comments.
